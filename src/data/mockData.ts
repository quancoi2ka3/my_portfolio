...
export const projects = [
  ...
  // },
  {
    ...
    githubLink: "https://github.com/quancoi2ka3/my_portfolio",
...
export const blogPosts = [
  {
    ...
    excerpt: "How I transitioned from a different career into the world of web development and the lessons I learned along the way.",
    content: "Five years ago, I was working in a completely different field with no background in programming or web development. I had always been interested in technology, but never thought I had what it takes to become a developer.\n\nIt all started when I needed to create a simple website for a personal project. Instead of hiring someone, I decided to learn the basics myself. What began as a small side project quickly turned into a passion as I discovered the joy of bringing ideas to life through code.\n\nThe learning curve was steep. I spent countless nights watching tutorials, taking online courses, and building small projects to practice my skills. There were moments of frustration when things didn't work as expected, but the satisfaction of solving problems kept me going.\n\nOne of the biggest challenges was overcoming the impostor syndrome. Even as I improved, I constantly compared myself to experienced developers and felt like I didn't belong. It took time to realize that everyone starts somewhere, and that the tech community is generally supportive of newcomers who are eager to learn.\n\nAfter about a year of self-study, I built my first professional website for a local business. Seeing my work live and being used by real people was an incredible feeling. This small success gave me the confidence to pursue web development more seriously.\n\nI joined online communities, attended local meetups, and eventually landed my first junior developer position. The transition wasn't easy – I took a significant pay cut and started at the bottom – but it was worth it to do something I truly enjoyed.\n\nLooking back, I'm grateful for the journey. Web development has not only provided me with a fulfilling career but has also taught me valuable life lessons about perseverance, continuous learning, and the importance of community.\n\nTo anyone considering a similar path, my advice is simple: start small, be consistent, build real projects, and don't be afraid to ask for help. The road may be challenging, but if you're passionate about creating things for the web, it's absolutely worth it.",
    date: "April 15, 2023",
    author: "Your Name",
    ...
    tags: ["Career Change", "Web Development", "Learning Journey"]
  },
  {
    id: 2,
  ...
  {
    id: 5,
    title: "Learning to Embrace Failure in Software Development",
    excerpt: "How changing my relationship with failure has made me a better developer and a more resilient person.",
    content: "In my first job as a developer, I was terrified of making mistakes. I would triple-check my code before committing, avoid taking on tasks I wasn't completely confident in, and feel devastated when bugs were found in my work. This fear of failure wasn't just stressful – it was actively holding back my growth as a developer.\n\nOver time, I've completely transformed my relationship with failure, coming to see it not as something to avoid at all costs, but as an essential part of the learning process. This shift didn't happen overnight, but it has fundamentally changed how I approach my work and my professional development.\n\nThe turning point came during a particularly challenging project. Under tight deadlines, I made a significant error that caused problems in production. I was mortified, but my team lead's response surprised me. Instead of criticism, she asked, \"What did you learn from this?\" That simple question reframed the situation from a failure to be ashamed of into a valuable learning opportunity.\n\nGradually, I began to internalize this perspective. I started keeping a \"failure journal\" where I documented mistakes, what caused them, and what I learned as a result. Looking back through this journal months later, I could clearly see how these supposed failures had contributed to my growth far more than my successes had.\n\nI also began to notice how the most innovative companies and teams embraced a culture that allowed for failure. Google's famous \"20% time\" policy, which gave engineers freedom to work on side projects, inherently accepted that many of these experiments would fail – but the ones that succeeded could be revolutionary. Similarly, the concept of \"failing fast\" in agile development recognizes that early failures save resources and lead to better outcomes in the long run.\n\nAs I've grown more comfortable with failure, I've become more willing to take on challenging tasks, experiment with new approaches, and share incomplete ideas. This has not only accelerated my learning but has also led to more creative solutions than I would have found if I had stuck only to the safe and familiar.\n\nOf course, embracing failure doesn't mean being careless or not trying to do quality work. It's about recognizing that mistakes are inevitable in complex work like software development, and that how we respond to those mistakes matters more than the fact that they occurred.\n\nI've also found that this mindset extends beyond coding. Whether it's learning a new language, trying a new hobby, or navigating personal relationships, viewing failures as feedback rather than final judgments creates resilience and encourages growth.\n\nFor newer developers who might be where I was years ago – afraid to make mistakes and feeling like everyone else knows more – I hope you can short-circuit this process and start embracing the learning opportunities that come from failure. Ask questions, take on challenges that stretch your abilities, and remember that every experienced developer has a long history of bugs, errors, and failed approaches behind them.\n\nIn an industry that changes as rapidly as ours, the ability to learn from failure isn't just a nice personal quality – it's a professional necessity. The developers who will thrive are not those who make the fewest mistakes, but those who learn the most from the mistakes they inevitably make.",
    date: "January 30, 2024",
    author: "Your Name",
    image: "https://images.unsplash.com/photo-1594322436404-5a0526db4d13?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1129&q=80",
    tags: ["Professional Growth", "Resilience", "Learning"]
  },
  {
    id: 6,
